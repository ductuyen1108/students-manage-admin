...
import { useDeleteAttendance } from 'src/attendance/common/hooks/useDeleteAttendance';
import { idLesson, isPopup, listIdDelete, setPopup } from '../slice';
...
export default function ModalConfirmDelete() {
  ...
  const lessonId = useSelector(idLesson);

  console.log("studentIds: ", selectIds);
  console.log("lessonId: ", lessonId);

  const { showSuccessSnackbar, showErrorSnackbar } = useMessage();
  const { mutate: mutationDelete } = useDeleteAttendance({
    onSuccess: () => {
