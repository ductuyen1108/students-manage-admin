...
import { useGetClassAndCount } from '../common/hooks/useGetClassAndCount';
import ClassAndCountFilter from './ClassAndCountFIlter';
import { dataFilter } from '../common/slice';

const ChartClassAndCount = () => {
...
export default ChartClassAndCount;
